...
2. [[App developers/Staked tokens|App developers stake]]: Based on the service they need to cover, app developers optimize their stake to get discounted prices on network credits
...
8. [[Operators/Centralized node management|Centralized node management]]: AUKI Labs updates the number of centralized nodes based on the number of decentralized nodes in the network, targetting a certain ratio of centralized nodes
